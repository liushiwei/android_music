    ...
    implements View.OnCreateContextMenuListener, MusicUtils.Defs, ServiceConnection
{
    ...
    public void onCreate(Bundle icicle)
    {
        ...
        if (mAdapter == null) {
            ...
            setListAdapter(mAdapter);
            mFolderCursor = mAdapter.getCursor();
    ...
    private void setTitle() {
        ...
        if (mFolderCursor != null && mFolderCursor.getCount() > 0) {
            mFolderCursor.moveToFirst();
            fancyName = mFolderCursor.getString(
                    mFolderCursor.getColumnIndex(MediaStore.Audio.Albums.ARTIST));
    ...
    public void onCreateContextMenu(ContextMenu menu, View view, ContextMenuInfo menuInfoIn) {
        ...
        mFolderCursor.moveToPosition(mi.position);
        mCurrentAlbumId = mFolderCursor.getString(mFolderCursor.getColumnIndexOrThrow(MediaStore.Audio.Albums._ID));
        mCurrentAlbumName = mFolderCursor.getString(mFolderCursor.getColumnIndexOrThrow("folder"));
        mCurrentArtistNameForAlbum = mFolderCursor.getString(
                mFolderCursor.getColumnIndexOrThrow(MediaStore.Audio.Albums.ARTIST));
    ...
    void doSearch() {
        ...
        // Since we hide the 'search' menu item when both Folder and artist are
    ...
    protected void onListItemClick(ListView l, View v, int position, long id)
    {
        ...
        intent.putExtra("Folder", Long.valueOf(id).toString());
    ...
    static class FolderListAdapter extends SimpleCursorAdapter implements SectionIndexer {
        ...
        FolderListAdapter(Context context, FolderBrowserActivity currentactivity,
            ...
            Bitmap b = BitmapFactory.decodeResource(r, R.drawable.ic_folder);
        ...
        private void getColumnIndices(Cursor cursor) {
            if (cursor != null) {
                mAlbumIdx = cursor.getColumnIndexOrThrow("folder");
        ...
        public void bindView(View view, Context context, Cursor cursor) {
            ...
            // we just use it to see if there is Folder art or not
        ...
        public void changeCursor(Cursor cursor) {
            ...
            if (cursor != mActivity.mFolderCursor) {
                mActivity.mFolderCursor = cursor;
                getColumnIndices(cursor);
