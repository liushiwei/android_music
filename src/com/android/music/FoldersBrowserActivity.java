...
public class FoldersBrowserActivity extends ExpandableListActivity
        implements View.OnCreateContextMenuListener, MusicUtils.Defs, ServiceConnection
{
    ...
    private BroadcastReceiver mTrackListListener = new BroadcastReceiver() {
        ...
        public void onReceive(Context context, Intent intent) {
            ...
            MusicUtils.updateNowPlaying(FoldersBrowserActivity.this);
        }
    };
    private BroadcastReceiver mScanListener = new BroadcastReceiver() {
        @Override
        public void onReceive(Context context, Intent intent) {
            MusicUtils.setSpinnerState(FoldersBrowserActivity.this);
    ...
    static class FolderListAdapter extends SimpleCursorTreeAdapter implements SectionIndexer {
        ...
        private FoldersBrowserActivity mActivity;
        ...
        public void setActivity(FoldersBrowserActivity newactivity) {
